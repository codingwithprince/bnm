...
const ImageShow = () => {
  ...
  return (
    ...
    <div className='flex flex-wrap justify-center gap-5 '>
        {
           images.map(data => <img data-aos="zoom-in-down" className=' h-[250px] shadow-sm transition ease-in-out duration-200 m-2 sm:m-4 rounded-lg hover:scale-105' key={data.id} src={data.img} alt={data.id} />) 
        }
    </div>
