...
const Hero = () => {
  ...
  return (
    ...
    className='pt-[55px] sm:px-[5%]  sm:py-[120px] sm:pt-[160px] flex items-center bg-white'>
      <div className="hero md:px-[2%] py-0 grid grid-cols-1 lg:grid-cols-3">
        {/* =============== Slider with image =================== */}

        <div data-aos="fade-right" className="hero-image-slider col-span-2 text-gray-700 flex justify-center items-center">
        ...
        {/* ======== text =========== */}
          ...
          <div data-aos="fade-left" className="hero-text sm:ml-[15%] p-2 mt-5 text-left text-white md:mt-10">
            ...
            <TypeAnimation
              className='text-gray-800 md:text-4xl md:text-left text-center text-2xl font-semibold '
              cursor={true}
